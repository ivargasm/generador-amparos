...
const useAmparoStore = create<AmparoStore>((set, get) => ({
    ...
    camposAmparo: {
        "Amparo Directo": [
            ...
            { name: "documento_representante", label: "Documentos representante legal", required: false, info: "Describe el documento con el cual acreditas ser representante legal"},
            ...
            { name: "suspencion_acto", label: "Suspencion del acto reclamado", required: false, info: "se solicita para evitar que se cause un daño irreparable antes de que se resuelva el juicio"  },
            { name: "pruebas", label: "Pruebas", required: false, info: "Documentos o elementos que sirven para demostrar la existencia del acto reclamado" },
        ],
        "Amparo Indirecto": [
            ...
            { name: "nombre_quejoso", label: "Nombre del Quejoso", required: true, info: "Nombre completo de la persona que solicita el amparo." },
            { name: "domicilio_quejoso", label: "Domicilio del Quejoso", required: true, info: "Dirección donde se pueden recibir notificaciones relacionadas con el amparo." },
            { name: "licenciados", label: "Autorizados", required: false, info: "Nombres de los abogados o personas autorizadas para actuar en el procedimiento." },
            { name: "cedulas", label: "Cédulas Profesionales", required: false, info: "Número de cédula profesional de los abogados autorizados." },
            ...
            { name: "domicilio_tercero", label: "Domicilio del Tercero Interesado", required: false, info: "Dirección de la persona interesada en el juicio." },
