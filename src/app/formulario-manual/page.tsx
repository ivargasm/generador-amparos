...
export default function FormularioManual() {
    ...
    return (
        <motion.div className="flex flex-col items-center justify-center bg-gradient-to-r from-purple-800 to-purple-600 min-h-screen pl-6 pr-6">
            <motion.div
                ...
                className="w-full max-w-4xl mx-auto p-8 bg-slate-50 rounded-xl shadow-xl mt-10 mb-10"
            >
                <motion.h2
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
    ...
    // return (
    //     <motion.div
    //         className="flex flex-col items-center justify-center bg-gradient-to-r from-purple-800 to-purple-600"
    //     >
    ...
    //             animate={{ opacity: 1, y: 0 }}
    //             transition={{ duration: 0.4 }}
    //             className="w-[50%] mx-auto p-6 bg-slate-400 rounded-xl shadow-xl mt-10"
    //         >
    //             <motion.h2
    //                 initial={{ opacity: 0, y: -10 }}
    //                 animate={{ opacity: 1, y: 0 }}
